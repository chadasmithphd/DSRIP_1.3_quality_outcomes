...
# TO DO 
- [ ] Color pallete
- [ ] Verify dates and years are correct
- [ ] check table rounding
- [ ] check table when missing
- [ ] Need to add oeq.R from APM to emilys path
- [ ] can i add a line above texas in the rhp participation

# Questions
- Should I change axis on 1.4 from 17, 18, etc to the same DYY (YYYY)
